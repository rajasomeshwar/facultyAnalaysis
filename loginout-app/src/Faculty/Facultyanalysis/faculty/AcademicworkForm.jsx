    ...
    <div className="feedback-container">
      ...
      <table className="feedback-table">
        ...
        <tbody>
            ...
            <tr key={row.id}>
              ...
              <td>
                <input
                  ...
                  value={row.scheduledClasses}
                  onChange={(e) => handleInputChange(e, row.id)}
                  placeholder="Scheduled Classes"
                />
              </td>
              <td>
                <input
              ...
              <td>
                <input
                  type="number"
                  name="apiScoreFeedback"
                  value={row.apiScoreFeedback}
                  onChange={(e) => handleInputChange(e, row.id)}
                  placeholder="API Score Feedback"
                  min="0"
                  max="20"
                />
              </td>
          ...
          <tr>
            <td colSpan="6">Average percentage</td>
            <td colSpan="4">Total API score (Results + Feedback)</td>
          </tr>
        </tbody>
      </table>
      ...
      <div className="extra-academics-container">
        <h3 className="extra-academics-heading">
          Please describe instances where you have gone the extra mile in
          academics during 2023
        </h3>
        <textarea
