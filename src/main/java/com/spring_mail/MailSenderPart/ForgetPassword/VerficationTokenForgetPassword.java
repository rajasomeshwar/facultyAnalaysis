...
@Entity
public class VerficationTokenForgetPassword {
	      @Id
   ...
   public VerficationTokenForgetPassword(String token, ApplicationUser user) {
       super();
       this.token = token;
       this.user = user;
   ...
   public VerficationTokenForgetPassword(String token) {
       super();
       this.token = token;
       this.expireDate = this.getTokenExpirationTime();
   }
   public VerficationTokenForgetPassword() {
       super();
